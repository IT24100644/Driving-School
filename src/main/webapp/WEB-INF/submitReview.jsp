...
<html>
<head>
    <title>Submit Review - Driving School</title>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <% if ("instructor".equals(request.getAttribute("reviewType"))) { %>
                    <% Instructor instructor = (Instructor) request.getAttribute("instructor"); %>
                    <h5>Review for Instructor: <%= instructor.getName() %></h5>
                    <% } else { %>
                    <% Lesson lesson = (Lesson) request.getAttribute("lesson"); %>
                    <h5>Review for Lesson on <%= lesson.getStartTime().toLocalDate() %></h5>
                    <% } %>
                    ...
                    <form action="${pageContext.request.contextPath}/review/submit" method="post">
                        ...
                        <input type="hidden" name="entityId"
                               value="${reviewType eq 'instructor' ? instructor.id : lesson.id}">
